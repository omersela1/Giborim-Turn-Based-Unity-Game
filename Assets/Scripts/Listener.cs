...
namespace AssemblyCSharp
{
	...
	{						
		...
		public delegate void UserLeftRoomHandler(RoomData eventObj, string userName);
		public static event UserLeftRoomHandler OnUserLeftRoom;
		...
		public void onConnectDone(ConnectEvent eventObj)
		{
			...
			{
				Debug.Log("Connection request successful.");
				if (OnConnect != null)
				{
					OnConnect(true);
				}
